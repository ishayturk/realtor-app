...
# Last Update: 21/02/2026 | 11:22 (Jerusalem Time GMT+2)
# Status: Exam Frame Fixed | Protocol: Full File Delivery
# ==========================================
...
if st.session_state.step == "login":
    ...
    if st.button("כניסה") and u:
        st.session_state.update({"user": u, "

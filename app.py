...
if S.step == "login":
    ...
    המערכת סונכרנה מול חומרי הלימוד המעודכנים ביותר של משרד המשפטים לשנת 2026.<br><br>
    <b>מה ניתן לעשות כאן?</b><br>
    * 📚 <b>למידה ממוקדת:</b> בחרו נושא וקבלו שיעור מקיף שנוצר בזמן אמת.<br>
    * ✍️ <b>תרגול שאלות:</b> בסוף כל שיעור תוכלו לייצר שאלון של 10 שאלות לתרגול הידע.<br><br>

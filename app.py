# ==========================================
# Project: מתווך בקליק | Version: 1213 Final Stable
# Status: Syntax Verified | Protocol: Full File Delivery
# ==========================================
...
if st.session_state.step == "login":
    ...
    with c_user:
        st.markdown(f'<div style="text-align:center; font-weight:900;">{st.session_state.user}</div>', 
                    unsafe_allow_html=True)
    with c_back:
        if st.button("חזרה", key="ex_bk"):

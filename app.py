...
<style>
    * { direction: rtl; text-align: right; }
    ...
    .exam-link { background-color: #f0f2f6; border: 1px solid #d1d5db; }
    .v-footer {
        text-align: center;
...
if st.session_state.step == "login":
    ...
    with c2:
        # יצירת הלינק עם שם המשתמש כפרמטר
        ...
        st.markdown(f'<a href="{exam_url}" target="_self" class="exam-link">⏱️ גש/י למבחן</a>', unsafe_allow_html=True)
    ...
    st.markdown(f'<div class="v-footer">Version: 1213-Linked</div>', unsafe_allow_html=True)

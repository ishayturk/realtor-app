        ...
        with f2:
            if st.session_state.get("lesson_txt") and st.session_state.lesson_txt != "LOADING":
                if not st.session_state.quiz_active:
                    ...
                    # כפתור בדוק תשובה
                    btn_check_disabled = (user_choice is None or st.session_state.ans_checked)
                    if st.button("✅ בדוק תשובה", disabled=btn_check_disabled):
                    ...
                    if st.session_state.q_count < 10:
                        btn_next_disabled = not st.session_state.ans_checked
                        if st.button("➡️ שאלה הבאה", disabled=btn_next_disabled):
                            menu_zone.empty()
                        ...
                        btn_finish_disabled = not st.session_state.ans_checked
                        if st.button("🏁 סיכום שאלון", disabled=btn_finish_disabled):

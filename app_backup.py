...
# ==========================================
# 1. עיצוב חזותי - יישור ימני וצבעים לנייד
# ==========================================
def apply_design():
...
def main():
    ...
    if st.session_state.view == "login":
        ...
        # תיקון: index=None גורם לזה ששום תשובה לא תהיה בחורה מראש
        ...
        if st.session_state.show_f:
            ...
            if choice == correct_text: st.success("נכון מאוד!")
            else: st.error(f"לא נכון. התשובה היא: {correct_text}")
